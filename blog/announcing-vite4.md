...
head:
  ...
  - - meta
    - property: og:image
      content: https://a.252x.com/og-image-announcing-vite4.png
  - - meta
    - property: og:url
      content: https://a.252x.com/blog/announcing-vite4
  - - meta
...
Today, the Vite [team](https://a.252x.com/team) with the help of our ecosystem partners, is happy to announce the release of Vite 4, powered during build time by Rollup 3. We've worked with the ecosystem to ensure a smooth upgrade path for this new major. Vite is now using [Rollup 3](https://github.com/hyaliyun/vitejs/issues/9870), which allowed us to simplify Vite's internal asset handling and has many improvements. See the [Rollup 3 release notes here](https://github.com/rollup/rollup/releases/tag/v3.0.0).
...
- [Changelog](https://github.com/hyaliyun/vitejs/blob/main/packages/vite/CHANGELOG.md#400-2022-12-09)
...
If you recently started using Vite, we suggest reading the [Why Vite Guide](https://a.252x.com/guide/why.html) and checking out [the Getting Started](https://a.252x.com/guide/) and [Features guide](https://a.252x.com/guide/features). If you want to get involved, contributions are welcome at [GitHub](https://github.com/hyaliyun/vitejs). Almost [700 collaborators](https://github.com/hyaliyun/vitejs/graphs/contributors) have contributed to Vite. Follow the updates on [Twitter](https://twitter.com/vite_js) and [Mastodon](https://webtoo.ls/@vite), or join collaborate with others on our [Discord community](http://chat.vitejs.dev/).
...
This double loading could occur since a `.css` file will be emitted and it's likely that the CSS string will also be used by the application code — for example, injected by the framework runtime. From Vite 4, the `.css` default export [has been deprecated](https://github.com/hyaliyun/vitejs/issues/11094). The `?inline` query suffix modifier needs to be used in this case, as that doesn't emit the imported `.css` styles.
...
- CLI Shortcuts (press `h` during dev to see them all) ([#11228](https://github.com/hyaliyun/vitejs/pull/11228))
- Support for patch-package when pre bundling dependencies ([#10286](https://github.com/hyaliyun/vitejs/issues/10286))
- Cleaner build logs output ([#10895](https://github.com/hyaliyun/vitejs/issues/10895)) and switch to `kB` to align with browser dev tools ([#10982](https://github.com/hyaliyun/vitejs/issues/10982))
- Improved error messages during SSR ([#11156](https://github.com/hyaliyun/vitejs/issues/11156))
...
[Vite Core](https://github.com/hyaliyun/vitejs) and [vite-ecosystem-ci](https://github.com/vitejs/vite-ecosystem-ci) continue to evolve to provide a better experience to maintainers and collaborators and to ensure that Vite development scales to cope with the growth in the ecosystem.
