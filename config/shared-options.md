...
- **实验性：** [提供反馈](https://github.com/hyaliyun/vitejs/discussions/15835)
- **类型：** `number | true`
...
- **实验性：** [提供反馈](https://github.com/hyaliyun/vitejs/discussions/13845)
- **类型：** `boolean`
- **默认：** `false`
...
- **实验性：** [提供反馈](https://github.com/hyaliyun/vitejs/discussions/13835)
...
内建支持的资源类型列表可以在 [这里](https://github.com/hyaliyun/vitejs/blob/main/packages/vite/src/node/constants.ts) 找到。
